...
class BookmarkPage2 extends StatefulWidget {
  BookmarkPage2({Key? key}) : super(key: key);

  @override
  State<BookmarkPage2> createState() => _BookmarkPage2State();
}

class _BookmarkPage2State extends State<BookmarkPage2> {
  ...
  Future<List> func() async {
    setState(() async {
      var x = await HiveDatabase.box.values;
      lst.addAll(x);
    });
    return await lst;
  }
  ...
  Widget _markedBooks(String name, String duration, String imageLink,
      String releaseDate, String synopsis, String details, String podcastId) {
